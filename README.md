...
O script que realiza esta ação é o [filtrar_blast.py](filtrar_blast.py).
...
Tendo as IDs dos hits, nos arquivos .csv, o próximo passo é rodar o [script_fastas_hits.py](script_fastas_hits.py).
